        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="animate__animated animate__fadeInUp animate__delay-1s">
              ...
              <ul className="space-y-3">
                <li>
                  <Link href="https://www.linkedin.com/in/sayantan-c12/" target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-blue-400 transition-colors">
                    <svg className="w-5 h-5 mr-3 text-blue-500" fill="currentColor" viewBox="0 0 20 20">
                ...
                <li>
                  <Link href="https://github.com/Chakraborty-Sayantan/" target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-blue-400 transition-colors">
                    <svg className="w-5 h-5 mr-3 text-blue-500" fill="currentColor" viewBox="0 0 20 20">
