        ...
        <div className="flex items-center justify-between h-12">
          ...
          <div className="hidden md:flex items-center space-x-10">
            <div className="ml-5 flex items-center space-x-12">
              ...
              <Link href="https://drive.google.com/file/d/1n26lIMkzSY0Jyo6ChEteZkf62qeJrqjO/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md text-sm font-medium">Download CV</Link>
            </div>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-white dark:bg-neutral-900 border-t border-neutral-200 dark:border-neutral-800">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <Link href="/resume.pdf" target="_blank" rel="noopener noreferrer" className="bg-blue-600 hover:bg-blue-700 block px-4 py-2 rounded-md text-base font-medium">Download CV</Link>
          </div>
        </div>
      )}
    </nav>
