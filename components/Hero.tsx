    ...
    <section id="hero" className="min-h-[70vh] pt-16 pb-16 relative text-neutral-900 dark:text-white overflow-hidden py-16 bg-neutral-50 dark:bg-neutral-950">
      ...
      <div className="container mx-auto px-4 flex flex-col justify-center h-full relative z-10">
        <div className="max-w-4xl mx-auto text-center mt-20">
          ...
          >
            <Link href="mailto:sayantanchakraborty2000@gmail.com" className="flex items-center gap-2 bg-neutral-200 hover:bg-neutral-300 dark:bg-neutral-800 dark:hover:bg-neutral-700 text-neutral-800 dark:text-white px-4 py-2 rounded-lg transition-colors">
            ...
            <Link href="https://www.linkedin.com/in/sayantan12102000/" target="_blank" className="flex items-center gap-2 bg-neutral-200 hover:bg-neutral-300 dark:bg-neutral-800 dark:hover:bg-neutral-700 text-neutral-800 dark:text-white px-4 py-2 rounded-lg transition-colors">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            ...
            <Link href="https://github.com/Hacker-Man07" target="_blank" className="flex items-center gap-2 bg-neutral-200 hover:bg-neutral-300 dark:bg-neutral-800 dark:hover:bg-neutral-700 text-neutral-800 dark:text-white px-4 py-2 rounded-lg transition-colors">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
